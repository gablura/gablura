          ...
          {showRoleSelect ? (
            ...
            <div className="p-1">
              {canChangeRole && (
                ...
                >
                  <svg className="size-4 text-text-muted" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              ...
              >
                {isBanned ? (
                  <>
                    <svg className="size-4 text-success" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                  ...
                  <>
                    <svg className="size-4 text-warning" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
