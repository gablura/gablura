...
function parseContentBlocks(raw: string) {
  ...
  // If no code blocks found, detect inline code blocks by content
...
export default function PackageInstallation({
  pkg,
