...
interface SdkApiReferenceProps {
  sdk: Resource;
}

export default function SdkApiReference({ sdk }: SdkApiReferenceProps) {
  const docs = sdk.documentation;
    ...
    <div className="rounded-xl border border-border-subtle bg-surface p-6 sm:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Complete API documentation for {sdk.name}.
        </p>
      </div>
